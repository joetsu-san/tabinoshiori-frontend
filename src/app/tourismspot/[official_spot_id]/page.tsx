...
const OfficialSpotDetail = () => {
  ...
  return (
    <div>
      <Image
        src={TourismDetailDatas.officialSpotDetail.officialSpotImages[0].src}
        fit="cover"
        alt="観光地画像"
        height={300}
      />
      <Container size="xl" mt={15} style={{ position: "relative" }} pb="6rem">
        ...
        <Text size={12}>{TourismDetailDatas.officialSpotDetail.description}</Text>
        ...
        <Card p={0} h={300} mt={10} pt={30}>
          ...
          <Text fw={500} size={14} color={"#555555"} mb={10}>
            {TourismDetailDatas.officialSpotDetail.address}
          </Text>
          <iframe
