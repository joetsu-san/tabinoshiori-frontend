...
import type { Methods as Methods5 } from "./private_spot/_private_spot_id@string";
import type { Methods as Methods6 } from "./travel_plan";
import type { Methods as Methods7 } from "./travel_plan/_travel_plan_id@string";
import type { Methods as Methods8 } from "./travel_plan/_travel_plan_id@string/spot";
import type { Methods as Methods9 } from "./travel_plan/_travel_plan_id@string/spot/_travel_plan_spot_id@string";
...
const api = <T>({ baseURL, fetch }: AspidaClient<T>) => {
  ...
  return {
    ...
    model_course_bookmark: {
      ...
      $get: (option?: { config?: T | undefined } | undefined) =>
        fetch<Methods2["get"]["resBody"], BasicHeaders, Methods2["get"]["status"]>(prefix, PATH1, GET, option)
          .json()
          .then((r) => r.body),
      ...
      $put: (option: { body: Methods2["put"]["reqBody"]; config?: T | undefined }) =>
        fetch<void, BasicHeaders, Methods2["put"]["status"]>(prefix, PATH1, PUT, option)
          .send()
          .then((r) => r.body),
      ...
      $delete: (option: { body: Methods2["delete"]["reqBody"]; config?: T | undefined }) =>
        fetch<void, BasicHeaders, Methods2["delete"]["status"]>(prefix, PATH1, DELETE, option)
          .send()
          .then((r) => r.body),
      $path: () => `${prefix}${PATH1}`,
    },
    ...
    private_spot: {
      _private_spot_id: (val1: string) => {
        ...
        return {
          ...
          $get: (option?: { config?: T | undefined } | undefined) =>
            fetch<Methods5["get"]["resBody"], BasicHeaders, Methods5["get"]["status"]>(prefix, prefix1, GET, option)
              .json()
              .then((r) => r.body),
    ...
    travel_plan: {
      _travel_plan_id: (val1: string) => {
        ...
        return {
          ...
          $get: (option?: { config?: T | undefined } | undefined) =>
            fetch<Methods7["get"]["resBody"], BasicHeaders, Methods7["get"]["status"]>(prefix, prefix1, GET, option)
              .json()
              .then((r) => r.body),
          put: (option: { body: Methods7["put"]["reqBody"]; config?: T | undefined }) =>
            fetch<void, BasicHeaders, Methods7["put"]["status"]>(prefix, prefix1, PUT, option).send(),
          $put: (option: { body: Methods7["put"]["reqBody"]; config?: T | undefined }) =>
            fetch<void, BasicHeaders, Methods7["put"]["status"]>(prefix, prefix1, PUT, option)
              .send()
              .then((r) => r.body),
          delete: (option?: { config?: T | undefined } | undefined) =>
            fetch<void, BasicHeaders, Methods7["delete"]["status"]>(prefix, prefix1, DELETE, option).send(),
          $delete: (option?: { config?: T | undefined } | undefined) =>
            fetch<void, BasicHeaders, Methods7["delete"]["status"]>(prefix, prefix1, DELETE, option)
              .send()
              .then((r) => r.body),
          $path: () => `${prefix}${prefix1}`,
        };
      ...
      $get: (option?: { config?: T | undefined } | undefined) =>
        fetch<Methods6["get"]["resBody"], BasicHeaders, Methods6["get"]["status"]>(prefix, PATH4, GET, option)
          .json()
          .then((r) => r.body),
      $path: () => `${prefix}${PATH4}`,
    },
